<x-layout>
    <div class="container py-md-5 container--narrow">
        <h2>
          <img class="avatar-small" src="{{$sharedData['avartar']}}" /> {{$sharedData['username']}}
          @auth
          ...
          <a href="/manage-avatar" class='btn btn-sm btn-danger'>Change profile picture</a>
          @endif
          @endauth
...
<div class='profile-slot-contents'>
    {{$slot}}
